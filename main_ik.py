...
def go(edit_kart):
    ...
    for name in files:
        ...
        if path.suffix in {'.docx'}:
            ...
            if edit_kart and str(path).replace('..\\..\\', '').replace('Цнап\\Картки\\ІК', '') in ['\\1.docx', '\\2.docx', '\\4.docx', '\\5.docx', '\\16.docx', '\\17.docx', '\\18.docx', '\\19.docx', '\\20.docx', '\\21.docx', '\\22.docx', '\\23.docx', '\\24.docx', '\\25.docx', '\\26.docx', '\\27.docx', '\\28.docx', '\\29.docx', '\\30.docx', '\\31.docx', '\\32.docx', '\\33.docx', '\\34.docx', '\\35.docx', '\\36.docx', '\\37.docx', '\\38.docx', '\\39.docx', '\\40.docx', '\\41.docx', '\\42.docx', '\\44.docx', '\\45.docx', '\\46.docx','\\47.docx', '\\48.docx', '\\49.docx', '\\50.docx', '\\56.docx', '\\58.docx', '\\57.docx', '\\59.docx', '\\60.docx', '\\61.docx', '\\62.docx', '\\63.docx', '\\64.docx', '\\66.docx', '\\67.docx', '\\68.docx', '\\70.docx', '\\71.docx', '\\72.docx', '\\ІК Встановлення учасника війни.docx']:
        ...
        with open(r"result.txt", "w", encoding="utf-8") as file:
            ...
            for  line in out_:
                if '..\\..\\' in line:
                    ...
                    # _line_ = line.split('\n')
                    # if len(_line_) == 2:
                    #     line = '\n' + _line_[1].replace('\\dist')
                    try:
                        t = int(  re.sub(r'\D', '', line ) )
                        if t - t_ != 1:
